...
tm_shape(precs) + 
  tm_fill(col="violetred2") +
  tm_borders(col="blue") +  
  tm_text("Ward_Precinct",size="AREA",col="orange")
```
...
# Voting Polling Stations of Worcester

[Actual Data](https://gisdata.worcesterma.gov/)

This link shows where this data had originated from, a reliable source coming directly from the Worcester, MA governmental administration.
